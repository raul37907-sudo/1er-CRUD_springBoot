package com.raul.crud.backFront;

import org.springframework.boot.SpringApplication;
import org.springframework.boot.autoconfigure.SpringBootApplication;

@SpringBootApplication
public class CrudBackFrontApplication {

    public static void main(String[] args) {
        SpringApplication.run(CrudBackFrontApplication.class, args);
    }
...
el  borrado  es por  correo
                             http://localhost:8080/usuarios/delete/rodhd@example.com

get   general  http://localhost:8080/usuarios
get  por  id http://localhost:8080/usuarios/3
...
post    "nombre": "Ana",
     ...
     "materno": "Garcíaaa",
      "edad": 32,
       "mail": "ana@example.com"}
 ESTO  ES CON  EL  RESTCONTROLLER PARA  DEVOLVER   JSON
	 */


/*  ESTO  ES CON  CONTROLLER PARA DEVOLVER  VISTAS

/usuarios → lista todos los usuarios.

/usuarios/nuevo → formulario para crear.

/usuarios/editar/{id} → formulario para editar.

/usuarios/eliminar/{mail} → elimina el usuario.
